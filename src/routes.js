...
import SupervisorProfile from "./views/Pages/Supervisors/SupervisorProfile";
...
const routes = [
  ...
  { path: '/employees/:id', name: 'Сотрудник' , component: EmployeeProfile},
  ...
  { path: '/supervisors/:id', name: 'Руководител' , component: SupervisorProfile},
  { path: '/supervisors' , name:'Список руководителей',component: Supervisors},
];
